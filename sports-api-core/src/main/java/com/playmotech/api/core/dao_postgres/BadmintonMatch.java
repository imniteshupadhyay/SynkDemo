...
public class BadmintonMatch {
	...
	@ManyToMany(mappedBy = "badmintonMatch", cascade = CascadeType.ALL, fetch = FetchType.EAGER)
	private List<BadmintonTeamMapping> teams;

	@ManyToMany(mappedBy = "badmintonMatch", cascade = CascadeType.ALL, fetch = FetchType.EAGER)
	private List<BadmintonSinglesPlayerMapping> singlePlayers;
	...
	// new entity mapping for game format TEAMS
	@ManyToMany(mappedBy = "badmintonMatch", cascade = CascadeType.ALL, fetch = FetchType.EAGER)
	private List<BadmintonMatchTeamPlayerMapping> badmintonMatchTeamPlayers;
}
