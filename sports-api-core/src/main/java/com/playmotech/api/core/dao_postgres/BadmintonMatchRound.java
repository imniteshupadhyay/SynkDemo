...
@Data
@Entity
@Table(name = "badminton_match_rounds")
public class BadmintonMatchRound {
	...
	private BadmintonMatchPlayDetail badmintonMatchPlayDetail;
	...
	@OneToMany(fetch = FetchType.EAGER, mappedBy = "badmintonMatchRound", cascade = CascadeType.ALL)
	private List<BadmintonMatchRoundsPlayDetail> badmintonMatchRoundsPlayDetails;
}
